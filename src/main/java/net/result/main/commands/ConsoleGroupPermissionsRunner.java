...
public class ConsoleGroupPermissionsRunner {
    ...
    public static void addRolePerm(ConsoleContext context, UUID chatID, UUID roleID, Permission permission) throws Exception {
        PermissionClientChain chain = new PermissionClientChain(context.client);
        context.io.chainManager.linkChain(chain);
    ...
    public static void removeRolePerm(ConsoleContext context, UUID chatID, UUID roleID, Permission permission) throws Exception {
        PermissionClientChain chain = new PermissionClientChain(context.client);
        context.io.chainManager.linkChain(chain);
