...
public class PersonalKeyMessage extends MSGPackMessage<PersonalKeyDTO> {
    public PersonalKeyMessage(String nickname, KeyDTO encryptor, KeyStorage keyStorage)
    ...
    public PersonalKeyMessage() {
        super(new Headers().setType(MessageTypes.PERSONAL_KEY), new PersonalKeyDTO());
    }
