...
public class Main {
    ...
    public static void main(String @NotNull [] args) throws IOException, ReadingKeyException, GeneralSecurityException, NoSuchEncryptionException, EncryptionException, DecryptionException {
